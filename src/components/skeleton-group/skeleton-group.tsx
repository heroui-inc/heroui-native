 ...
 * Passes isLoading, variant, shimmerConfig, and pulseConfig to child items via context.
 *
 ...
 *
 * Props flow from SkeletonGroup to Items via context (isLoading, variant, shimmerConfig, pulseConfig).
